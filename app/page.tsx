          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <CardContent className={item.image !== null ? "p-6" : "p-6 min-h-[200px] flex flex-col justify-center"}>
      ...
      <section id="certificates" className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="p-8 hover:shadow-lg transition-shadow duration-300 border-2 border-blue-100">
              <CardContent className="p-0">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <h3 className="font-serif text-xl font-bold text-slate-900 mb-2">NPTEL Certification</h3>
                    <p className="text-blue-600 font-medium mb-3">Roll No: 23F3001070</p>
                  </div>
                </div>
                <p className="text-slate-600 text-sm leading-relaxed">
                  Successfully completed NPTEL certification program demonstrating proficiency in the subject area.
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-0">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold text-slate-900">54/100</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-600">Assignment:</span>
                    <span className="font-semibold text-slate-900">15.85/25</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-600">Exam:</span>
                    <span className="font-semibold text-slate-900">37.89/75</span>
                  </div>
                  <p className="text-slate-600 text-sm leading-relaxed pt-2">
                    Comprehensive 12-week course on solar energy engineering fundamentals and renewable energy
